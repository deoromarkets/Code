...
{
    public class SyncVendWatch : ISyncData
    {
        ...
        public void Init()
        {
            ...
            client = new deOROService.SyncDataServiceClient("WSHttpBinding_ISyncDataService", ApplicationConfig.DeOROServiceUrlBase);
            client.ClientCredentials.UserName.UserName = ApplicationConfig.DeOROServiceAccessUserNameBase;
            client.ClientCredentials.UserName.Password = ApplicationConfig.DeOROServiceAccessPasswordBase;
        ...
        public bool DownloadCredit()
        {
            ...
            try
            {
                DataSet ds = client.DownloadData(ApplicationConfig.CustomerIdBase, ApplicationConfig.LocationIdBase,
