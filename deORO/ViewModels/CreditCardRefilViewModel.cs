...
namespace deORO.ViewModels
{
    public class CreditCardRefilViewModel : BaseViewModel
    {
        ...
        private async void CardReaderData(CreditCardData cardData)
        {
            ...
            string transactionDetails = string.Format("A0|200|{0}|1|{1}", selectedOption * 100, "Account Refill using Credit Card");
            ...
            await Task.Run(() =>
            {
                ...
                {
                    cardProcessor.ProcessSale(cardData, selectedOption, transactionDetails, zipCode);
                }
        ...
        private void ExecuteOKCommand()
        {
            ...
            cardReader.SetParams(selectedOption);
