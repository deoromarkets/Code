...
namespace deORO.BarcodeScanner
{
    public class Honeywell
    {
        ...
        private void SetupEvents()
        {
            ...
            posScanner.StatusUpdateEvent +=
                        new StatusUpdateEventHandler(
                        co_OnStatusUpdateEvent);

            posScanner.DirectIOEvent +=
                        new DirectIOEventHandler(
                        co_OnDirectIOEvent);
            EventInfo dataEvent =
                        posScanner.GetType().GetEvent(
                        "DataEvent");
            if (dataEvent != null)
            {
                dataEvent.AddEventHandler(posScanner,
            ...
            if (errorEvent != null)
            {
                errorEvent.AddEventHandler(posScanner,
            ...
            if (outputCompleteEvent != null)
            {
                outputCompleteEvent.AddEventHandler(
                        posScanner, new OutputCompleteEventHandler(
        ...
        private void RaiseEvent_errorEvent(object[] eventdata)
        {
