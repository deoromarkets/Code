...
namespace deORO.Helpers
{
    public class Enum
    {
        ...
        {
            BarcodeScanner, CreditCardReader, FingerPrintReader, Bill, Coin, None, E2C, Login, InventoryAdjusted
        }
        ...
        {
            BillPay = 1, CoinPay = 2, CreditCardPay = 4, BillRefill = 8, CoinRefill = 16, CreditCardRefill = 32, MyAccountPay = 64, Reward = 128, ChangeAbandoned = 256
        }
